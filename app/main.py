...
def load_model():
    ...
    """
    print('reading model...')
    MLFLOW_TRACKING_URI = 'https://dagshub.com/rodrigo.peri/mlops-ead.mlflow'
    MLFLOW_TRACKING_USERNAME = 'rodrigo.peri'
    MLFLOW_TRACKING_PASSWORD = '2482efab4b75da0f7887bbeccdd572c0e9887411'
